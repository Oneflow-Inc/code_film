...
paddings[0] # 表示上下pad各1个像素
paddings[1] # 表示左右pad各2个像素
...
constant_padded[0, :], constant_padded[-1, :] # 上下是全0
...
reflect_paded[0, :],  reflect_paded[2, :] # 结果第0行与第2行相等

reflect_paded[-1, :], reflect_paded[2, :] # 结果第4行与第2行相等

reflect_paded[:, 0:2], reflect_paded[:, 3:5] # 结果第0和1列 与 第3和4列 呈镜像关系
...
symmetric_paded[0, :],  symmetric_paded[1, :] # 结果第0行与第1行相等

symmetric_paded[-1, :], symmetric_paded[3, :] # 结果第4行与第3行相等

symmetric_paded[:, 0:2], symmetric_paded[:, 2:4] # 结果第0和1列 与 第2和3列 呈镜像关系

symmetric_paded[:, -2:], symmetric_paded[:, 3:5] # 结果第5和6列 与 第3和4列 呈镜像关系
